...
|---------|--------------|----------------|
| **Astrocytes** | Non-neuronal glial cells that support and regulate neural activity in the brain | Newly understood as active participants in fear memory formation and extinction, not just passive support cells |
| **Amygdala** | An almond-shaped brain structure that is the central hub for processing fear, threat detection, and emotional memory | Hyperactive amygdala function underlies anxiety disorders and PTSD; its regulation is a primary target of treatment |
